...
function DebugSessionProvider(
  ...
  var DebugSession = (function() {
     ...
     */
    function DebugSession(serverUrl, Logger, $rootScope) {
  ...
  this.$get = ["Logger", "$rootScope", function(Logger, $rootScope) {
    // return a new debug session for the configured serverUrl
    return new DebugSession(serverUrl, Logger, $rootScope);
  }];
